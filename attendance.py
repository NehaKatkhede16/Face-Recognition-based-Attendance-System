...
haarcasecade_path = "C:\\Users\\nehak\\OneDrive\\Documents\\Desktop\\Final_Project\\Attendance-Management-system-using-face-recognition-master\\haarcascade_frontalface_alt.xml"
trainimagelabel_path = (
    "C:\\Users\\nehak\\OneDrive\\Documents\\Desktop\\Final_Project\\Attendance-Management-system-using-face-recognition-master\\TrainingImageLabel\\Trainner.yml"
)
trainimage_path = "C:\\Users\\nehak\\OneDrive\\Documents\\Desktop\Final_Project\\Attendance-Management-system-using-face-recognition-master\\TrainingImage"
studentdetail_path = (
    "C:\\Users\\nehak\\OneDrive\\Documents\\Desktop\\Final_Project\\Attendance-Management-system-using-face-recognition-master\\StudentDetails\\studentdetails.csv"
)
attendance_path = "C:\\Users\\nehak\\OneDrive\\Documents\\Desktop\\Final_Project\\Attendance-Management-system-using-face-recognition-master\\Attendance"
...
img =Image.open('C:\\Users\\nehak\\OneDrive\\Documents\\Desktop\\Final_Project\\Attendance-Management-system-using-face-recognition-master\\UI_Image\\bgImage1.jpg')
...
#     report_file_path = "C:\Users\nehak\OneDrive\Documents\Desktop\Final_Project\\Attendance-Management-system-using-face-recognition-master\\Attendance\\CCS\\attendance.csv"
...
def send_report():
    class AttendanceSheetSender:
        def __init__(self):
            ...
            self.options = ["Select Subject","Javascript", "CCS", "CNS", "Linux","ETCMIT",".NET"]
            ...
            tk.Button(self.root, text="Send Email", command=self.send_email).grid(row=2, column=1, padx=10, pady=10)

        def send_email(self):
            email = self.email_entry.get()
            sub = self.selected_option.get()
            file_path = f"C:\\Users\\nehak\\OneDrive\\Documents\\Desktop\\Final_Project\\Attendance-Management-system-using-face-recognition-master\\Attendance\\{sub}\\attendance.csv"
